...
const Work = () => {
  ...
  const handleSlideChange = (swiper) => {
    // get current slide index and set the project
    const currentIndex = swiper.activeIndex;
    // update the project state on current index change
        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              {/* slider button */}
              <WorkSliderBtns
                contoinerStyles="flex gap-2 absolute right-0 bottom-[calc(50%_-_22px)] xl:bottom-0 z-20 w-full justify-between xl:w-max xl:justify-none"
